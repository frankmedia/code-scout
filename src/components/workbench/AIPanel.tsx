        ...
        const triagePrompt: ModelRequestMessage[] = [
          {
            ...
            content: [
              ...
              'Decide if you can answer DIRECTLY, or if a plan (file changes, grep, commands) is needed.',
              '',
              'Reply with EXACTLY one of:',
              'DIRECT: <your full answer to the user>',
              'PLAN: <reason why a plan is needed>',
              '',
              'IMPORTANT: The file tree below is TRUNCATED — you can only see a fraction of the project.',
              'If the user asks about specific files, libraries, or code usage (e.g. "is X used?",',
